...
def get_argparse():
    ...
    # 数据
    # parser.add_argument("--max_len", default=1024, type=int, help="最大长度")
    parser.add_argument("--overwrite_cache",  default=False, help="")
    # parser.add_argument("--model_name_or_path", default='google-bert/bert-base-chinese', type=str, help="预训练模型的路径")
