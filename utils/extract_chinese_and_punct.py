...
max_seq_length = 500
tokenizer = BertTokenizer.from_pretrained('google-bert/bert-base-chinese', do_lower_case=True)
# tokenizer = BertTokenizer.from_pretrained('/data/zhoujx/prev_trained_model/rbt3', do_lower_case=True)
